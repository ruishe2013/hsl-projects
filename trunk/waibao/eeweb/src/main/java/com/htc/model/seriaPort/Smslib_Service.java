	...
	public class InboundNotification implements IInboundMessageNotification {
		public void process(AGateway gateway, MessageTypes msgType, InboundMessage msg){
			...
			if (msgType == MessageTypes.INBOUND){
				System.out.println(">>>收到短信① New Inbound message detected from Gateway: " + gateway.getGatewayId());
			}else if (msgType == MessageTypes.STATUSREPORT){
				System.out.println(">>>收到短信② New Inbound Status Report message detected from Gateway: " + gateway.getGatewayId());
			}			
...
//			}			
	...
	public class OrphanedMessageNotification implements	IOrphanedMessageNotification {
		public boolean process(AGateway gateway, InboundMessage msg) {
			// TODO Auto-generated method stub
			System.out.println(">>> 大消息接收 Orphaned message part detected from " + gateway.getGatewayId());
			System.out.println(msg);

...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="main_content1">
		  <div align="left" style="padding-left:20px; font-weight:bold;">设备管理--[修改]</div>
		  <div class="user_list">
			    ...
			    <table width="100%" border="0" cellspacing="0" cellpadding="0">
			      <tr>
			        <td class="table-tr-top"><div align="center">修改设备</div></td>
			      </tr>
			      <tr>
			        <td>
							<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="table_warp">
							  ...
							  <tr>
								...
								<tr>		  	
							  	<td class="table_left" ><strong><label>电量值(V)</label></strong></td>
							  	<td  class="table_right">
							  ...
							  <tr>
								...
								<tr class="humi_show">		  	
							  	<td class="table_left" ><strong><label>湿度范围</label></strong></td>
							  	<td  class="table_right">
								...
								<tr>		  	
							  	<td class="table_left" ><strong><label>电量信息</label></strong></td>
							  	<td class="table_right">
							  ...
							  <s:if test="showZj==2">
									<tr>		  	
								  	<td class="table_left" ><strong><label>Access状态</label></strong></td>
								  	<td class="table_right">
							  ...
							  <s:else>
								...
								<tr>		  	
							  	<td class="table_left" ><strong><label>备注</label></strong></td>
							  	<td class="table_right">
			      ...
			      <tr>
			        <td class="user_list_01">
			        	<div align="center" class="table_buttom">
			        		<a href="#" onclick="submitUpdate(1)">修改设备</a> 

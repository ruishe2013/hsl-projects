...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<div class="main_content1" >
	  <div align="left" style="padding-left:20px; font-weight:bold;">管理中心--[用户管理]</div>
	  <div class="user_list">
			...
			<div align="left" class="user_list_01">
				权限<s:select list="searchPowers" name="searchPower" listKey="key"	listValue="value" value="searchPower"/>
				用户名<s:textfield name="searchName" size="20" maxlength="15" />
				<a href="#" onclick="submitList(3,0)">搜 索</a>
				<a href="#" onclick="submitList(1,0)">新建用户</a>				
			...
			<div class="table-bg">
				<table cellspacing="1" cellpadding="0" width="100%" border="0">
					<s:if test="userList.size == 0">
						<caption >
							<div class="list_no_data">用户列表为空...</div>
						</caption>	
					</s:if>
					<s:else>				
						<thead>
							<tr>
								...
								<td class="table-tr-top"><div align="center"><strong>用户名</strong></div></td>
								<td class="table-tr-top"><div align="center"><strong>权限</strong></div></td>
							...
							<s:iterator value="userList" status="st" id="lists">
								<tr>
									...
									<td class="user_list_line">
										[<a href="#" onclick="submitList(4,${userId});">修 改</a>]&nbsp;&nbsp;
										[<a href="#" onclick="submitList(5,${userId});">删 除</a>]
									</td>
								</tr>
							</s:iterator>							
						</tbody>

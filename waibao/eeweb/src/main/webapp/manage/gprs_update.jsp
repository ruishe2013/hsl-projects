...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="main_content1" style="margin-top:10px;">
			<div align="left" style="padding-left:20px; font-weight:bold;">短信格式--[修改]</div>
			<div class="user_list">
			<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
			    ...
			    <td valign="top" width="60%">
				    ...
				    <table width="100%" cellspacing="0" cellpadding="0" style="padding-bottom: 6px;">
				      <tr>
				      	<td class="table-tr-top"><div align="center">修改短信发送格式</div></td>
				      </tr>
				      <tr>
				        <td>
				        ...
				        <td class="user_list_01">
				        	<div align="center" class="table_buttom">
				        		<a href="#" onclick="submitUpdate(1);">修改格式</a>

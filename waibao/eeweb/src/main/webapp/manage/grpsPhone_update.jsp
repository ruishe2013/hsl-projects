...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="main_content1">
		  <div align="left" style="padding-left:20px; font-weight:bold;">通讯列表--[修改]</div>
		  <div class="user_list">
		  	<s:form namespace="/mana" theme="simple" validate="ture" name="updatePhoneForm">
			    ...
			    <table width="100%" border="0" cellspacing="0" cellpadding="0">
			      <tr>
			        <td class="table-tr-top"><div align="center">修改系统用户</div></td>
			      </tr>
			      <tr>
			        <td>
			      ...
			      <tr>
			        <td class="user_list_01">
			        	<div align="center" class="table_buttom">
			        		<a href="#" onclick="submitUpdate(1)">修改通讯</a> 

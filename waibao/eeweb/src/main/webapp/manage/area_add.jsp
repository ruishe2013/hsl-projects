...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="main_content1">
		  <div align="left" style="padding-left:20px; font-weight:bold;">区域管理--[新建 ]</div>
		  <div class="user_list">
			<s:form namespace="/mana" theme="simple" validate="ture" name="addAreaForm">
				<s:hidden name="currentPage"/>
				<!-- 需要输入的字段 -->		  
		    <table width="100%" border="0" cellspacing="0" cellpadding="0">
		      <tr>
		      	<td class="table-tr-top"><div align="center">新建区域</div></td>
		      </tr>
		      <tr>
		        <td>
		      ...
		      <tr>
		        <td class="user_list_01">
		        	<div align="center" class="table_buttom">
		        		<a href="#" onclick="submitAdd(1);">新建区域</a>
